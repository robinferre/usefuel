...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // hide the title to use the textView title with the depedencies Calligraphy
        ...
        //go to the fuel fragment when mainActivity's called
        loadFragment(new FragmentFuel());
    }
    ...
    private void loadFragment(Fragment fragment) {
        ...
        fragmentTransaction.replace(R.id.currentFragment, fragment);
